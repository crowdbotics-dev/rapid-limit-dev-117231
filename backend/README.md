...
## Project Structure
    ...
    ├── rapid_limit_dev_117231  # Django project configurations
...
1. Clone this repo and `cd rapid_limit_dev_117231`
...
2. Clone this repo and `cd rapid_limit_dev_117231`
