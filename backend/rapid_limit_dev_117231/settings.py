"""
Django settings for rapid_limit_dev_117231 project.
...
ROOT_URLCONF = 'rapid_limit_dev_117231.urls'
...
WSGI_APPLICATION = 'rapid_limit_dev_117231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rapid_limit_dev_117231 API",
    "DESCRIPTION": "API documentation for rapid_limit_dev_117231 App",
    "VERSION": "v1",
}
